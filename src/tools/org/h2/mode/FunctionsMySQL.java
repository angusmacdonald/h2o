 ...
 * (http://h2database.com/html/license.html). Initial Developer: Jason Brittain (jason.brittain at gmail.com)
 */
package org.h2.mode;
...
public class FunctionsMySQL {
	...
	/**
	 * Format replacements for MySQL date formats. See
	 * http://dev.mysql.com/doc/refman/5.1/en/date-and-time-functions.html#function_date-format
	 */
	private static final String[] FORMAT_REPLACE = new String[] { "%a", "EEE", "%b", "MMM", "%c", "MM", "%d", "dd", "%e", "d", "%H", "HH",
			"%h", "hh", "%I", "hh", "%i", "mm", "%j", "DDD", "%k", "H", "%l", "h", "%M", "MMMM", "%m", "MM", "%p", "a", "%r", "hh:mm:ss a",
			"%S", "ss", "%s", "ss", "%T", "HH:mm:ss", "%W", "EEEE", "%w", "F", "%Y", "yyyy", "%y", "yy", "%%", "%", };
	...
	/**
	 * Get the seconds since 1970-01-01 00:00:00 UTC. See
	...
	/**
	 * Get the seconds since 1970-01-01 00:00:00 UTC of the given timestamp. See
	 * http://dev.mysql.com/doc/refman/5.1/en/date-and-time-functions.html#function_unix-timestamp
	 * 
	 * @param timestamp
	 *            the timestamp
	...
	/**
	 * See http://dev.mysql.com/doc/refman/5.1/en/date-and-time-functions.html#function_date This function is dependent on the exact
	 * formatting of the MySQL date/time string.
	 * 
	 * @param dateTime
	 *            The date/time String from which to extract just the date part.

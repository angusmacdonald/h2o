...
public class Build extends BuildBase {
	...
	public void benchmark() {
		download("ext/hsqldb-1.8.0.7.jar", "http://repo1.maven.org/maven2/hsqldb/hsqldb/1.8.0.7/hsqldb-1.8.0.7.jar",
				"20554954120b3cc9f08804524ec90113a73f3015");
		download("ext/derby-10.4.2.0.jar", "http://repo1.maven.org/maven2/org/apache/derby/derby/10.4.2.0/derby-10.4.2.0.jar",
		...
		download("ext/derbynet-10.4.2.0.jar", "http://repo1.maven.org/maven2/org/apache/derby/derbynet/10.4.2.0/derbynet-10.4.2.0.jar",
		...
		String cp = "temp" + File.pathSeparator + "bin/h2" + getJarSuffix() + File.pathSeparator + "ext/hsqldb.jar" + File.pathSeparator
				+ "ext/hsqldb-1.8.0.7.jar" + File.pathSeparator + "ext/derby-10.4.2.0.jar" + File.pathSeparator
				+ "ext/derbyclient-10.4.2.0.jar" + File.pathSeparator + "ext/derbynet-10.4.2.0.jar" + File.pathSeparator
				+ "ext/postgresql-8.3-603.jdbc3.jar" + File.pathSeparator + "ext/mysql-connector-java-5.1.6.jar";
	...
	private void compile(boolean debugInfo, boolean clientOnly, boolean basicResourcesOnly) {
		...
		download();
		String classpath = "temp" + File.pathSeparator + "ext/servlet-api-2.4.jar" + File.pathSeparator + "ext/lucene-core-2.2.0.jar"
				+ File.pathSeparator + "ext/slf4j-api-1.5.0.jar" + File.pathSeparator + "ext/org.osgi.core-1.2.0.jar" + File.pathSeparator
		...
		if ( !clientOnly ) {
			...
			javac(new String[] { "-d", "temp", "-sourcepath", "src/test" + File.pathSeparator + "src/tools", "-classpath", classpath },
					files);
			files = getFiles("src/test").exclude("*.java").exclude("*/package.html");
	...
	/**
	 * Download all required jar files. Actually those are only compile time dependencies. The database can be used without any
	 * dependencies.
	 */
	public void download() {
		download("ext/servlet-api-2.4.jar", "http://repo1.maven.org/maven2/javax/servlet/servlet-api/2.4/servlet-api-2.4.jar",
				"3fc542fe8bb8164e8d3e840fe7403bc0518053c0");
		download("ext/lucene-core-2.2.0.jar", "http://repo1.maven.org/maven2/org/apache/lucene/lucene-core/2.2.0/lucene-core-2.2.0.jar",
				"47b6eee2e17bd68911e7045896a1c09de0b2dda8");
		download("ext/slf4j-api-1.5.0.jar", "http://repo1.maven.org/maven2/org/slf4j/slf4j-api/1.5.0/slf4j-api-1.5.0.jar",
	...
	public void jar() {
		...
		FileList files = getFiles("temp").exclude("temp/org/h2/build/*").exclude("temp/org/h2/dev/*").exclude("temp/org/h2/jaqu/*")
				.exclude("temp/org/h2/mode/*").exclude("temp/org/h2/samples/*").exclude("temp/org/h2/test/*").exclude("*.bat")
	...
	public void jarSmall() {
		...
		FileList files = getFiles("temp").exclude("temp/org/h2/bnf/*").exclude("temp/org/h2/build/*").exclude("temp/org/h2/dev/*")
				.exclude("temp/org/h2/fulltext/*").exclude("temp/org/h2/jaqu/*").exclude("temp/org/h2/jdbcx/*")
				.exclude("temp/org/h2/mode/*").exclude("temp/org/h2/samples/*").exclude("temp/org/h2/server/*")
				.exclude("temp/org/h2/test/*").exclude("temp/org/h2/tools/*").exclude("*.bat").exclude("*.sh").exclude("*.txt");
	...
	public void javadoc() {
		delete("docs");
		mkdir("docs/javadoc");
		javadoc(new String[] { "-sourcepath", "src/main", "org.h2.jdbc", "org.h2.jdbcx", "org.h2.tools", "org.h2.api", "org.h2.constant",
				"org.h2.fulltext", "-doclet", "org.h2.build.doclet.Doclet", "-classpath", "ext/lucene-core-2.2.0.jar" });
	...
	public void javadocImpl() {
		...
		javadoc(new String[] {
				"-sourcepath",
				"src/main" + File.pathSeparator + "src/test" + File.pathSeparator + "src/tools",
				"-noindex",
				"-d",
				"docs/javadocImpl2",
				"-classpath",
				System.getProperty("java.home") + "/../lib/tools.jar" + File.pathSeparator + "ext/slf4j-api-1.5.0.jar" + File.pathSeparator
						+ "ext/servlet-api-2.4.jar" + File.pathSeparator + "ext/lucene-core-2.2.0.jar" + File.pathSeparator
						+ "ext/org.osgi.core-1.2.0.jar", "-subpackages", "org.h2", "-exclude", "org.h2.test.jaqu:org.h2.jaqu" });
		...
		javadoc(new String[] {
				...
				System.getProperty("java.home") + "/../lib/tools.jar" + File.pathSeparator + "ext/slf4j-api-1.5.0.jar" + File.pathSeparator
						+ "ext/servlet-api-2.4.jar" + File.pathSeparator + "ext/lucene-core-2.2.0.jar" + File.pathSeparator
						+ "ext/org.osgi.core-1.2.0.jar", "-subpackages", "org.h2", "-exclude", "org.h2.test.jaqu:org.h2.jaqu", "-package",
	...
	/**
	 * This will build a release of the H2 .jar file and upload it to file:///data/h2database/m2-repo. This is only required when a new H2
	 * version is made.
	 */
	public void mavenDeployCentral() {
		...
		execScript("mvn", new String[] { "deploy:deploy-file", "-Dfile=bin/h2" + getJarSuffix(), "-Durl=file:///data/h2database/m2-repo",
				"-Dpackaging=jar", "-Dversion=" + getVersion(), "-DpomFile=bin/pom.xml", "-DartifactId=h2", "-DgroupId=com.h2database" });
	}
	...
	public void mavenInstallLocal() {
		...
		writeFile(new File("bin/pom.xml"), pom.getBytes());
		execScript("mvn", new String[] { "install:install-file", "-Dversion=1.0-SNAPSHOT", "-Dfile=bin/h2" + getJarSuffix(),
				"-Dpackaging=jar", "-DpomFile=bin/pom.xml", "-DartifactId=h2", "-DgroupId=com.h2database" });
	}
	
	private void resources(boolean clientOnly, boolean basicOnly) {
		FileList files = getFiles("src/main").exclude("*.MF").exclude("*.java").exclude("*/package.html").exclude("*/java.sql.Driver");
		if ( basicOnly ) {

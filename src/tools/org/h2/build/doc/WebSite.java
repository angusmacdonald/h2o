...
/**
 * Create the web site, mainly by copying the regular docs. A few items are different in the web site, for example it calls web site
 * analytics. Also, the main entry point page is different. The newsfeeds are generated here as well.
 */
public class WebSite {
	
	private static final String ANALYTICS_TAG = "<!-- analytics -->";
	
	private static final String ANALYTICS_SCRIPT = "<script src=\"http://www.google-analytics.com/ga.js\" type=\"text/javascript\"></script>\n"

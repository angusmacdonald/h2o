...
public class XMLParser {
	...
	/**
	 * Get the full name of the attribute. If there is no prefix, only the local name is returned, otherwise the prefix, ':', and the local
	 * name.
	 * 
	 * @param index
	 *            the index of the attribute (starting with 0)
	 ...
	 * 
	 * @param namespaceURI
	 *            the namespace URI (currently ignored)
	 * @param localName
	 *            the attribute name
	...
	/**
	 * Get the full name of the current start or end element. If there is no prefix, only the local name is returned, otherwise the prefix,
	 * ':', and the local name.
	 * 
	 * @return the full name
	 */

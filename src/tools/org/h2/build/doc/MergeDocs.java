...
/**
 * This application merges the html documentation to one file (onePage.html), so that the PDF document can be created.
 */
public class MergeDocs {
	...
	private void run() throws Exception {
		...
		String[] pages = { "quickstart.html", "installation.html", "tutorial.html", "features.html", "performance.html", "advanced.html",
				"grammar.html", "functions.html", "datatypes.html", "build.html", "history.html", "faq.html" };

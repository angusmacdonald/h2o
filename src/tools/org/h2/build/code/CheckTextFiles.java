...
/**
 * This tool checks that source code files only contain the allowed set of characters, and that the copyright license is included in each
 * file. It also removes trailing spaces.
 */
public class CheckTextFiles {
	...
	private static final String[] SUFFIX_CHECK = new String[] { "html", "jsp", "js", "css", "bat", "nsi", "java", "txt", "properties",
			"sql", "xml", "csv", "Driver" };
	
	private static final String[] SUFFIX_IGNORE = new String[] { "gif", "png", "odg", "ico", "sxd", "layout", "res", "win", "jar", "task",
			"svg", "MF", "sh", "DS_Store" };
	...
	/**
	 * Check a source code file. The following properties are checked: copyright, license, incorrect source switches, trailing white space,
	 * newline characters, tab characters, and characters codes (only characters below 128 are allowed).
	 * 
	 * @param file
	 *            the file to check
	 * @param fix
	 *            automatically fix newline characters and trailing spaces
	 * @param checkLicense

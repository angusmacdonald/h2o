...
/**
 * This sample program opens the same database once in embedded mode, and once in the server mode. The embedded mode is faster, but only the
 * server mode supports remote connections.
 */

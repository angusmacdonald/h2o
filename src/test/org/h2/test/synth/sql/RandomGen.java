...
public class RandomGen {
	...
	/**
	 * Get a random integer. In 10% of the cases, Integer.MAX_VALUE is returned, in 10% of the cases Integer.MIN_VALUE. Also in the 10% of
	 * the cases, a random value between those extremes is returned. In 20% of the cases, this method returns 0. In 10% of the cases, a
	 * gaussian value in the range -200 and +1800 is returned. In all other cases, a gaussian value in the range -5 and +20 is returned.
	 * 
	 * @return the random value
	 */

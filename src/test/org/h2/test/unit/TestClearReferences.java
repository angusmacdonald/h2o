...
/**
 * Tests if Tomcat would clear static fields when re-loading a web application. See also
...
public class TestClearReferences extends TestBase {
	...
	private static final String[] KNOWN_REFRESHED = { "org.h2.util.DateTimeUtils.cachedCalendar", "org.h2.util.StringCache.softCache",
			"org.h2.value.Value.softCache", "org.h2.jdbcx.JdbcDataSourceFactory.cachedTraceSystem",
			"org.h2.compress.CompressLZF.cachedHashTable", "org.h2.store.fs.FileObjectMemory.cachedCompressedEmptyBlock",
			"org.h2.tools.CompressTool.cachedBuffer", "org.h2.util.MemoryUtils.reserveMemory", "org.h2.util.NetUtils.cachedLocalAddress",

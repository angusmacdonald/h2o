...
/**
 * Tests the DbStarter servlet. This test simulates a minimum servlet container environment.
 */
public class TestServlet extends TestBase {
	...
	/**
	 * Minimum ServletContext implementation. Most methods are not implemented.
	 */

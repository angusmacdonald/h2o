...
/**
 * This is a self-destructor class to kill a long running process automatically after a pre-defined time. The class reads the number of
 * minutes from the system property 'h2.selfDestruct' and starts a countdown thread to kill the virtual machine if it still runs then.
 */
public class SelfDestructor extends Thread {
	 ...
	 *            the default number of minutes after which the current process is killed.
	 */

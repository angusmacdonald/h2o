...
public class TestSampleApps extends TestBase {
	...
	public void test() throws Exception {
		...
		testApp(org.h2.tools.ChangeFileEncryption.class, null, "Allows changing the database file encryption password or algorithm*");
		testApp(org.h2.tools.DeleteDbFiles.class, new String[] { "-help" }, "Deletes all files belonging to a database.*");
	}

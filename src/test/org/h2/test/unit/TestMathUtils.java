...
public class TestMathUtils extends TestBase {
	...
	/**
	 * Calculate the factorial (n!) of a number. This implementation uses a naive multiplication loop, and is very slow for large n. For n =
	 * 1000, it takes about 10 ms. For n = 8000, it takes about 800 ms.
	 * 
	 * @param n
	 *            the number

...
public class TestExit extends TestBase implements DatabaseEventListener {
	...
	public void test() throws Exception {
		...
		String[] procDef = new String[] { "java", selfDestruct, "-cp", "bin" + File.pathSeparator + ".", getClass().getName(),
		...
		procDef = new String[] { "java", "-cp", "bin" + File.pathSeparator + ".", getClass().getName(), "" + OPEN_WITHOUT_CLOSE_ON_EXIT };

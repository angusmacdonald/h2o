...
public class TestFunctionOverload extends TestBase {
     ...
     * @return the value
     */
    public static int overload1or2(final int one) {
     ...
     */
    public static int overload1or2(final int one, final int two) {
     ...
     * @return the value
     */
    public static int overload1or2WithConn(final Connection conn, final int one) throws SQLException {
     ...
     * @return the sum of both
     */
    public static int overload1or2WithConn(final int one, final int two) {
     ...
     * @return the sum of both
     */
    public static int overloadError(final int one, final int two) {
     ...
     * @return the sum of both
     */
    public static int overloadError(final double one, final double two) {

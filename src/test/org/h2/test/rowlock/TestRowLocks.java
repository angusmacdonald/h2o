...
public class TestRowLocks extends TestBase {
    ...
    private void testSetMode() throws SQLException, IOException {

        deleteDb("rowLocks");
        c1 = getConnection("rowLocks");
        final Statement stat = c1.createStatement();
        stat.execute("SET LOCK_MODE 2");
        final ResultSet rs = stat.executeQuery("call lock_mode()");
        rs.next();
    ...
    private String getSingleValue(final Statement stat, final String sql) throws SQLException {

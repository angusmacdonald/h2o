...
/**
 * Tool to instrument java files with profiler calls. The tool can be used for profiling an application and for coverage testing. This class
 * is not used at runtime of the tested application.
 */
public class Coverage {
	...
	private void read() throws IOException {
		...
		if ( write == null
				|| ( !write.equals("else ") && !write.equals("else") && !write.equals("super ") && !write.equals("super")
						&& !write.equals("this ") && !write.equals("this") && !write.equals("} ") && !write.equals("}") ) ) {

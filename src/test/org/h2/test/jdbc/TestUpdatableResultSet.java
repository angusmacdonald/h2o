...
public class TestUpdatableResultSet extends TestBase {
    ...
    private void testUpdateLob() throws SQLException, IOException {
        ...
        deleteDb("updatableResultSet");
        final Connection conn = getConnection("updatableResultSet");
        Statement stat = conn.createStatement();
        stat.execute("CREATE TABLE object_index (id integer primary key, object other, number integer)");

        final PreparedStatement prep = conn.prepareStatement("INSERT INTO object_index (id,object)  VALUES (1,?)");
    ...
    private void testUpdateResetRead() throws SQLException, IOException {
    ...
    private void testScroll() throws SQLException, IOException {
    ...
    private void testUpdateDataType() throws SQLException, IOException {
    ...
    private void testUpdateDeleteInsert() throws SQLException, IOException {

        deleteDb("updatableResultSet");
        final Connection c1 = getConnection("updatableResultSet");
        final Connection c2 = getConnection("updatableResultSet");
        final Statement stat = c1.createStatement();
    ...
    private void testScrollable(final Connection conn, final int rows) throws SQLException {
        ...
        final Statement regular = conn.createStatement();
        testScrollResultSet(regular, ResultSet.TYPE_FORWARD_ONLY, rows);
        final Statement scroll = conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
        testScrollResultSet(scroll, ResultSet.TYPE_SCROLL_INSENSITIVE, rows);
    }

    private void testScrollResultSet(final Statement stat, final int type, final int rows) throws SQLException {
    ...
    private void checkState(final ResultSet rs, final boolean beforeFirst, final boolean first, final boolean last, final boolean afterLast) throws SQLException {

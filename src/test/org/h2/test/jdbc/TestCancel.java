...
public class TestCancel extends TestBase {
    ...
    static class CancelThread extends Thread {
        ...
        CancelThread(final Statement cancel, final int wait) {
    ...
    private void testReset() throws SQLException, IOException {

        deleteDb("cancel");
        final Connection conn = getConnection("cancel");
    ...
    private void testQueryTimeoutInTransaction() throws SQLException, IOException {
    ...
    private void testJdbcQueryTimeout() throws SQLException, IOException {
        ...
        final ResultSet rs = s2.executeQuery("SELECT VALUE FROM INFORMATION_SCHEMA.SETTINGS WHERE NAME = 'QUERY_TIMEOUT'");
        rs.next();
    ...
    private void testQueryTimeout() throws SQLException, IOException {
    ...
    private void testMaxQueryTimeout() throws SQLException, IOException {

        deleteDb("cancel");
        final int oldMax = SysProperties.getMaxQueryTimeout();
        try {
     ...
     * @return the value
     */
    public static int visit(final int x) {
    ...
    private void testCancelStatement() throws Exception {
        ...
        for (int i = 1;;) {
            ...
            final CancelThread cancel = new CancelThread(query, i);
            visit(0);
            cancel.start();
            Thread.yield();
            try {

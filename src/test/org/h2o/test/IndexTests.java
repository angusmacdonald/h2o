...
/**
 * This class tests H2O's CREATE REPLICA functionality with regards to its ability to maintain referential integrity by copying indexes for
 * primary keys, etc...
 * 
...
public class IndexTests {
	...
	public void setUp() throws Exception {
		...
		sa.execute("CREATE TABLE Address(id INT NOT NULL, street VARCHAR(255), PRIMARY KEY (id)); "
				...
				+ "INSERT INTO Address VALUES (0, 'Glasgow Road');" + "INSERT INTO Address VALUES (1, 'Kinnessburn Terrace');"
				+ "INSERT INTO Address VALUES (2, 'Lamond Drive');" + "INSERT INTO Address VALUES (3, 'North Street');"
				+ "INSERT INTO Address VALUES (4, 'Market Street');" + "INSERT INTO Address VALUES (5, 'Hawthorn Avenue');"
				+ "INSERT INTO Person VALUES (0, 'Angus Macdonald', 0);" + "INSERT INTO Person VALUES (1, 'Alan Dearle', 1);"
				+ "INSERT INTO Person VALUES (2, 'Graham Kirby', 2);" + "INSERT INTO Person VALUES (3, 'Dharini Balasubramaniam', 2);"
	...
	/**
	 * Check that a tableset ID is correctly given for all new tables, meaning that tables which refer to one another are given the same ID.
	 * 
	 * <p>
	 * This test is also a pretty good indicator of whether constraints are being correctly applied to tables (FOREIGN KEY references etc.),
	...
	public void checkTableSetID() {
		...
		try {
			/*
			 * These fail because the command which links the two tables doesn't work when query propagation is used on
			 * AlterTableAddConstraint. But if this feature is bypassed another set of tests fail.
			 */

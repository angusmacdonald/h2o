...
public class IndexTests {
    ...
    public void checkTableSetID() {
        ...
        try {
             ...
             */
            sa.execute("SELECT H2O.H2O_ONE_H2O_TM_TABLE.table_id, table_set FROM H2O.H2O_ONE_H2O_TM_TABLE, H2O.H2O_ONE_H2O_TM_REPLICA " + "WHERE H2O.H2O_ONE_H2O_TM_REPLICA.table_id=H2O.H2O_ONE_H2O_TM_TABLE.table_id ORDER BY table_id;");

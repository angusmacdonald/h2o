...
public class RestartTests {
	...
	/**
	 * Tests that a test table is still accessible when the database has been restarted. After restart this attempts to inserrt some rows
	...
	public void basicRestart() throws ClassNotFoundException {
		...
		try {
			...
			server = Server.createTcpServer(new String[] { "-tcpPort", "8585", "-SMLocation",
					"jdbc:h2:sm:tcp://localhost:8585/db_data/unittests/schema_test" });
			server.start();
			
			Class.forName("org.h2.Driver");
			conn = DriverManager.getConnection("jdbc:h2:sm:tcp://localhost:8585/db_data/unittests/schema_test",

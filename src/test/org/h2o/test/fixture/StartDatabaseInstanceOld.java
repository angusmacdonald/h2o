 ...
 */
public class StartDatabaseInstanceOld extends Thread {
    ...
    public static void main(final String[] args) {
        ...
        final StartDatabaseInstanceOld instance = new StartDatabaseInstanceOld(databaseConnectionString, port, true);
     ...
     */
    public StartDatabaseInstanceOld(final String connectionString, final boolean createConnectionInSeperateThread) {
    ...
    public StartDatabaseInstanceOld(final String databaseConnectionString, final String port, final boolean b) {

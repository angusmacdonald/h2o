...
public class ReplicaTests extends TestBase {
    ...
    public void SpaceInValue() {
        ...
        try {
            ...
            final String[] secondCol = {"Hello", "World", "Hello World"};
    ...
    public void SelectPrimaryWhenLocal() {
        ...
        try {
            ...
            final int[] pKey = {1, 2};
            final String[] secondCol = {"Hello", "World"};
    ...
    public void PushReplicationON() {
        ...
        try {
            ...
            final int[] pKey2 = {1, 2, 3};
            final String[] secondCol2 = {"Hello", "World", "Quite"};
    ...
    /**
     * Tests the 'push replication' feature by attempting to initiate replication creation on database C from database A, getting the data
     * from database B. The test first creates a replica on database B, then launches the ON-FROM replication command from database A.
     */
    @Test
    public void PushReplicationONFROM() {
        ...
        try {
            final Connection cc = DriverManager.getConnection("jdbc:h2:mem:three", PersistentSystemTable.USERNAME, PersistentSystemTable.PASSWORD);
            final Statement sc = cc.createStatement();
     ...
     * 
     * <p>
     * By default this operation should fail - DROP TABLE should be used instead.
     */
    @Test
    ...
    public void truncateTableTest() {
        ...
        try {
            ...
            sa.execute("TRUNCATE TABLE TEST");

            final ResultSet rs = sb.executeQuery("SELECT LOCAL ONLY * FROM TEST ORDER BY ID;"); // Now query on first machine (which should have one extra row).

            if (rs.next()) {
                fail("There should be no entries in this table.");
            }
        }
        catch (final SQLException e) {
            e.printStackTrace();

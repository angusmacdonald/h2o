 ...
 * codebase rather than directly from JUnit tests so they only run if a given test constant such as Constants.IS_H2O_TEST is set to true.
 * 
...
public class H2OTest {
	 ...
	 * Constants.IS_H2O_TEST = true. The database that is shutdown is named "mem:two".
	 * 
	 * @param allReplicas
	 */

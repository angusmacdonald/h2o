...
public class SystemTableTests {
	...
	public void schemaTableCreation() throws ClassNotFoundException, InterruptedException {
		...
		try {
			...
			server = Server.createTcpServer(new String[] { "-tcpPort", "9082", "-SMLocation",
					"jdbc:h2:sm:tcp://localhost:9082/db_data/unittests/schema_test" });
			server.start();
			
			Class.forName("org.h2.Driver");
			conn = DriverManager.getConnection("jdbc:h2:sm:tcp://localhost:9082/db_data/unittests/schema_test",
	...
	public void testTableInsertion() {
		...
		try {
			Connection ca = DriverManager.getConnection("jdbc:h2:sm:mem:one", PersistentSystemTable.USERNAME,

...
public class SystemTable implements SystemTableRemote {
	...
	/**
	 * Interface to the persisted state of this System Table. This object
	 * interacts with the database to store the state of the System Table on
	 * disk.
	 */
	...
	public SystemTable(Database db, boolean createTables) throws Exception {
		...
		this.migrationState = new SystemTableMigrationState(db
				.getChordInterface().getLocalChordReference());
	}

	/******************************************************************
	 **** Methods which require both in memory and persisted data structures to be
	 * updated.
	 ******************************************************************/
	...
	public int addConnectionInformation(DatabaseURL databaseURL,
			DatabaseInstanceWrapper remoteDatabase) throws RemoteException,
			MovedException {
		preMethodTest();
	 ...
	 * org.h2.h2o.comms.remote.TableManagerRemote, org.h2.h2o.TableInfo)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.h2.h2o.ISystemTable#removeTableInformation(java.lang.String,
	 * java.lang.String)
	 */
	@Override
	 ...
	 */
	@Override
	public void buildSystemTableState() throws RemoteException, MovedException,
			SQLException {
		preMethodTest();
	...
	public Map<TableInfo, Set<DatabaseURL>> getReplicaLocations()
			throws RemoteException, MovedException, MovedException {
	...
	public void removeAllTableInformation() throws RemoteException,
			MovedException, MovedException, MovedException {
		preMethodTest();
		try {
	...
	private void preMethodTest() throws RemoteException, MovedException {
		...
		if (migrationState.inMigration) {
			...
			long currentTimeOfMigration = System.currentTimeMillis()
					- migrationState.migrationTime;

			if (currentTimeOfMigration < MIGRATION_TIMEOUT) {
				throw new RemoteException(
						"System Table is in the process of being moved.");
			} else {
	 ...
	 */
	@Override
	public synchronized void prepareForMigration(String newLocation)
			throws RemoteException, MovedException, MigrationException {
		preMethodTest();
	...
	public void changeTableManagerLocation(TableManagerRemote stub,
			TableInfo tableInfo) throws RemoteException, MovedException {
		preMethodTest();
	...
	public void addTableManagerStateReplica(TableInfo table,
		...
		preMethodTest();
		inMemory.addTableManagerStateReplica(table, replicaLocation,
				primaryLocation, active);
		persisted.addTableManagerStateReplica(table, replicaLocation,
				primaryLocation, active);
	}
	...
	@Override
	public boolean checkTableManagerAccessibility() throws RemoteException,
			MovedException {
		preMethodTest();

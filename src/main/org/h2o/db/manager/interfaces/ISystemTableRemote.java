 ...
 */
public interface ISystemTableRemote extends IReplicaChoice, IMigratable { // used to extend Remote 
     ...
     * @throws SQLException
     */
    public void buildSystemTableState(ISystemTableRemote otherSystemTable) throws RPCException, MovedException, SQLException;
     ...
     * @throws SQLException
     */
    void buildSystemTableState() throws RPCException, MovedException, SQLException;

...
public interface ISystemTable extends Remote, IReplicaChoice {
	...
	/**
	 * Checks whether a Table Manager for the given table exists in the system.
	 * If it doesn't exist then it indicates that it is possible to create a
	...
	/**
	 * Confirm that the specified table has now been created, and provide a
	 * reference to the table's data manager.
	 * 
	 * @param tableManager
	 *            Table Manager for the given table.
	 * @param replicaLocations
	 * @param session
	 * @return True if this action was successful on the System Table; otherwise
	 *         false.
	 * @throws RemoteException
	 * @throws SQLException
	 */
	...
	/**
	 * Remove Table Manager from the system. This is used when a table is being
	 * dropped completely from the database system.
	 * 
	 * <p>
	 ...
	 * @return true if the Table Manager was dropped successfully; otherwise
	 *         false.
	 * @throws RemoteException
	 */
	...
	/**
	 * Get a new table set number from the System Table. Each number given is
	 * unique (i.e. the same number should not be given twice).
	 * 
	 * @return
	 */
	...
	/**
	 * Build the state of this System Table object by replicating the state of
	 * another schema manager.
	 * 
	...
	/**
	 * Build the state of this System Table object by replicating the state of
	 * the local persistent System Table.
	 * 
	 * @throws RemoteException
	 * @throws SQLException
	 */
	void buildSystemTableState() throws RemoteException, MovedException,
			SQLException;
	...
	/**
	 * Remove all references to Table Managers and replicas. Used to shutdown a
	 * System Table.
	 * 
	 * @throws RemoteException
	 */
	...
	/**
	 * Add a new location where a given table managers state has been
	 * replicated.
	 * 
	 * @param table
	 ...
	 * 
	 * @param table
	 *            The table whose manager has removed/lost a replica of its
	 *            state.
	 * @param replicaLocation
	...
	/**
	 * Recreate the table manager for the the table specified by the parameter
	 * if it has failed.
	 * 
	 * @param table
	 * @return
	...
	/**
	 * Instructs the System Table to check that all Table Managers are currently
	 * active.
	 * 
	 * @return
	 * @throws MovedException

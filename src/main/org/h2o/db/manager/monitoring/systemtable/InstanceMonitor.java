...
public class InstanceMonitor implements IMachineRanking {
     ...
     */
    List<MachineMonitoringData> summaries;
    private final Metric metric;

    public InstanceMonitor(final Metric metric) {

        this.metric = metric;
        summaries = new LinkedList<MachineMonitoringData>();
    }
    ...
    //        }
    //
    //        final List<MachineMonitoringData> normalizedResourceSummary = collateNormalizedResults(resultsStore);
    //
    ...
    //     * @return
    //     */
    //    private List<MachineMonitoringData> collateNormalizedResults(final Map<ResourceType, double[]> resultsStore) {
    //

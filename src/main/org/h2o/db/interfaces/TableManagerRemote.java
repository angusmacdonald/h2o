...
public interface TableManagerRemote extends H2ORemote, Migratable {
	...
	public QueryProxy getQueryProxy(LockType lockType, DatabaseInstanceWrapper databaseInstanceRemote) throws RemoteException,
	...
	public void releaseLockAndUpdateReplicaState(boolean commit, DatabaseInstanceWrapper requestingDatabase,
			Collection<CommitResult> commitedQueries, boolean asynchronousCommit) throws RemoteException, MovedException;

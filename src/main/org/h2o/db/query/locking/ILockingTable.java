...
/**
 * Interface for a table lock manager. Each manager controls access to a single
 * table. Calling classes can either request a lock or release a currently held
 * lock.
 * 

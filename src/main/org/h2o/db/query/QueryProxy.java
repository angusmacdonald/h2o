...
public class QueryProxy implements Serializable {
	 ...
	 */
	public QueryProxy(LockType lockGranted, TableInfo tableName, Map<DatabaseInstanceWrapper, Integer> allReplicas,
			TableManager tableManager, DatabaseInstanceWrapper requestingMachine, int updateID, LockType lockRequested) {

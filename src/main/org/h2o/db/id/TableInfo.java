...
public class TableInfo implements Serializable {
	...
	public TableInfo(String tableName, String schemaName, long modificationID,
			int tableSet, String tableType, DatabaseURL dbLocation) {
	 ...
	 * 
	 * <p>
	 * e.g. PUBLIC.TEST, where the table name is simply TEST and the table is in
	 * the PUBLIC schema.
	 * 
	 * @return
	 */

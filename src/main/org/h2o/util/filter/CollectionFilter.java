...
public class CollectionFilter {
	 ...
	 * @param target
	 *            The target of this collection filter. A collection of obejcts
	 *            of type T.
	 * @param predicate
	 *            The function to apply to each object in the connection.
	 * @param parameter
	 *            The parameter to be used as part of the test.
	 * @return The set of elements of target which meet the requirements of the
	 *         predicate function.
	 */
	public static <T, P> Set<T> filter(Collection<T> target,
			Predicate<T, P> predicate, P parameter) {

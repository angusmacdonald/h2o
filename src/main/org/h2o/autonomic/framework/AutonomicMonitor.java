...
/**
 * <p>
 * An autonomic monitor is responsible for monitoring some aspect of the database systems performance. For example, a 'replication factor'
 * monitor will constantly monitor the number of replicas in the system, and if there is a change in this number it will produce an event
 * which is sent to all register autonomic managers (see {@link AutonomicManager}).
 * 

...
/**
 * The components of the database system being monitored implement the
 * AutonomicController class to provide a mechanism for autonomic manager to
 * update the functionality being managed.
 * 
 * 

...
public class Settings {
    ...
    public static Properties defaultSettings() {
         ...
         */
        defaults.setProperty("NUMONIC_MONITORING_FILE_LOCATION", "JAR:numonic-settings" + File.separator + "default_numonic_settings.properties");
         ...
         */
        defaults.setProperty("NUMONIC_THRESHOLDS_FILE_LOCATION", "JAR:numonic-settings" + File.separator + "default_numonic_thresholds.properties");

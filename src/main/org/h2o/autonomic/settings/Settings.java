...
public class Settings {
    ...
    public static Properties defaultSettings() {
         ...
         */
        defaults.setProperty("METADATA_REPLICATION_THREAD_SLEEP_TIME", "2500");
         ...
         */
        defaults.setProperty("NUMONIC_MONITORING_FILE_LOCATION", "JAR:default_numonic_settings.properties");
         ...
         */
        defaults.setProperty("NUMONIC_THRESHOLDS_FILE_LOCATION", "JAR:default_numonic_thresholds.properties");

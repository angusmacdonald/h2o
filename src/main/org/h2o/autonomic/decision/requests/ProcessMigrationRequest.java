...
public class ProcessMigrationRequest extends ActionRequest {
	...
	public ProcessMigrationRequest(long expectedTimeToCompletion,
			long immediateDiskSpace, long expectedDiskSpace) {
		super(expectedTimeToCompletion, immediateDiskSpace, expectedDiskSpace,
				cpu, memory, network);
	}
}

...
/**
 * Static classes which create requests and responses to be sent to/from the
 * locator server.
 * 
...
public class LocatorProtocol {
	/**
	 * Indicates lock request is being made. Used when an instance wants to
	 * create a new System Table.
	 */
	public static final String LOCK = "LOCK";

	/**
	 * Indicates an instance has created a System Table and wishes to commit
	 * this action.
	 */
	...
	/**
	 * Creates a 'Lock' request, indicating the instance wants to create a new
	 * System Table instance.
	 * 
	 * <p>
	 * LOCK
	 * <ul>
	...
	/**
	 * Creates a 'Lock' response, indicating whether the lock was successfully
	 * taken out.
	 * 
	 * <p>
	 * LOCK
	 ...
	 * </ul>
	 * 
	 * The response will be '0' if the lock attempt failed, and a positive
	 * number if it succeeded. The positive number is the update count.
	 * 
	 * @return The string of the response to be sent.
	 */
	 ...
	 * @return The update count recieved from the server. This is '0' if no lock
	 *         was granted.
	 */
	...
	/**
	 * Creates a 'Commit' request, indicating the instance has created a System
	 * Table and wants to confirm it.
	 * 
	 * <p>
	 * CONFIRM
	 * <ul>

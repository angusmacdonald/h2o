...
/**
 * A savepoint is a point inside a transaction to where a transaction can be rolled back. The tasks that where done before the savepoint are
 * not rolled back in this case.
 */
...
// ## Java 1.4 end ##
{
    ...
    static String getName(String name, int id) {
        ...
        if (name != null) { return StringUtils.quoteJavaString(name); }
    ...
    private void checkValid() throws SQLException {
        ...
        if (conn == null) { throw Message.getSQLException(ErrorCode.SAVEPOINT_IS_INVALID_1, getName(name, savepointId)); }
    }
    ...
    public int getSavepointId() throws SQLException {
        ...
        try {
            ...
            checkValid();
            if (name != null) { throw Message.getSQLException(ErrorCode.SAVEPOINT_IS_NAMED); }
            return savepointId;
        }
        catch (Exception e) {
    ...
    public String getSavepointName() throws SQLException {
        ...
        try {
            ...
            checkValid();
            if (name == null) { throw Message.getSQLException(ErrorCode.SAVEPOINT_IS_UNNAMED); }
            return name;
        }
        catch (Exception e) {
            throw logAndConvert(e);

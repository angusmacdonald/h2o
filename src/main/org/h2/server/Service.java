...
/**
 * Classes implementing this interface usually provide a TCP/IP listener such as
 * an FTP server. The can be started and stopped, and may or may not allow
 * remote connections.
 */
public interface Service {
	...
	/**
	 * Start the service. This usually means create the server socket. This

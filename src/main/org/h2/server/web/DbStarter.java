...
/**
 * This class can be used to start the H2 TCP server (or other H2 servers, for example the PG server) inside a web application container
 * such as Tomcat or Jetty. It can also open a database connection.
 */

...
public class ValueStringIgnoreCase extends ValueStringBase {
    ...
    public static ValueStringIgnoreCase get(String s) {
        ...
        if (s.length() > SysProperties.OBJECT_CACHE_MAX_PER_ELEMENT_SIZE) { return obj; }
        ...
        if (cache.value.equals(s)) { return cache; }
        return obj;
    }

    public Value convertPrecision(long precision) {

        if (precision == 0 || value.length() <= precision) { return this; }

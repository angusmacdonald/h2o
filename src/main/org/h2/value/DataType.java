...
public class DataType {
    ...
    static {
        ...
        // ## Java 1.4 end ##
        add(Value.NULL, Types.NULL, "Null", new DataType(), new String[]{"NULL"}, 1);
        add(Value.STRING, Types.VARCHAR, "String", createString(true), new String[]{"VARCHAR", "VARCHAR2", "NVARCHAR", "NVARCHAR2", "VARCHAR_CASESENSITIVE", "CHARACTER VARYING", "TID"}, 4);
        add(Value.STRING, Types.LONGVARCHAR, "String", createString(true), new String[]{"LONGVARCHAR"}, 4);
        add(Value.STRING_FIXED, Types.CHAR, "String", createString(true), new String[]{"CHAR", "CHARACTER", "NCHAR"}, 4);
        add(Value.STRING_IGNORECASE, Types.VARCHAR, "String", createString(false), new String[]{"VARCHAR_IGNORECASE"}, 4);
        add(Value.BOOLEAN, DataType.TYPE_BOOLEAN, "Boolean", createDecimal(ValueBoolean.PRECISION, ValueBoolean.PRECISION, 0, ValueBoolean.DISPLAY_SIZE, false, false), new String[]{"BOOLEAN", "BIT", "BOOL"}, 1);
        add(Value.BYTE, Types.TINYINT, "Byte", createDecimal(ValueByte.PRECISION, ValueByte.PRECISION, 0, ValueByte.DISPLAY_SIZE, false, false), new String[]{"TINYINT"}, 1);
        add(Value.SHORT, Types.SMALLINT, "Short", createDecimal(ValueShort.PRECISION, ValueShort.PRECISION, 0, ValueShort.DISPLAY_SIZE, false, false), new String[]{"SMALLINT", "YEAR", "INT2"}, 5);
        add(Value.INT, Types.INTEGER, "Int", createDecimal(ValueInt.PRECISION, ValueInt.PRECISION, 0, ValueInt.DISPLAY_SIZE, false, false), new String[]{"INTEGER", "INT", "MEDIUMINT", "INT4", "SIGNED"}, 5);
        add(Value.LONG, Types.BIGINT, "Long", createDecimal(ValueLong.PRECISION, ValueLong.PRECISION, 0, ValueLong.DISPLAY_SIZE, false, false), new String[]{"BIGINT", "INT8"}, 5);
        add(Value.LONG, Types.BIGINT, "Long", createDecimal(ValueLong.PRECISION, ValueLong.PRECISION, 0, ValueLong.DISPLAY_SIZE, false, true), new String[]{"IDENTITY", "SERIAL"}, 5);
        add(Value.DECIMAL, Types.DECIMAL, "BigDecimal", createDecimal(Integer.MAX_VALUE, ValueDecimal.DEFAULT_PRECISION, ValueDecimal.DEFAULT_SCALE, ValueDecimal.DEFAULT_DISPLAY_SIZE, true, false), new String[]{"DECIMAL", "DEC"}, 17
        // TODO value: are NaN, Inf, -Inf,... supported as well?
        );
        add(Value.DECIMAL, Types.NUMERIC, "BigDecimal", createDecimal(Integer.MAX_VALUE, ValueDecimal.DEFAULT_PRECISION, ValueDecimal.DEFAULT_SCALE, ValueDecimal.DEFAULT_DISPLAY_SIZE, true, false), new String[]{"NUMERIC", "NUMBER"}, 17
        // TODO value: are NaN, Inf, -Inf,... supported as well?
        );
        add(Value.FLOAT, Types.REAL, "Float", createDecimal(ValueFloat.PRECISION, ValueFloat.PRECISION, 0, ValueFloat.DISPLAY_SIZE, false, false), new String[]{"REAL", "FLOAT4"}, 5);
        add(Value.DOUBLE, Types.DOUBLE, "Double", createDecimal(ValueDouble.PRECISION, ValueDouble.PRECISION, 0, ValueDouble.DISPLAY_SIZE, false, false), new String[]{"DOUBLE", "DOUBLE PRECISION"}, 4);
        add(Value.DOUBLE, Types.FLOAT, "Double", createDecimal(ValueDouble.PRECISION, ValueDouble.PRECISION, 0, ValueDouble.DISPLAY_SIZE, false, false), new String[]{"FLOAT", "FLOAT8"}, 4
        // TODO value: show min and max values, E format if supported
        );
        add(Value.TIME, Types.TIME, "Time", createDate(ValueTime.PRECISION, "TIME", 0, ValueTime.DISPLAY_SIZE), new String[]{"TIME"}, 10
        // TODO value: min / max for time
        );
        add(Value.DATE, Types.DATE, "Date", createDate(ValueDate.PRECISION, "DATE", 0, ValueDate.DISPLAY_SIZE), new String[]{"DATE"}, 10
        // TODO value: min / max for date
        );
        add(Value.TIMESTAMP, Types.TIMESTAMP, "Timestamp", createDate(ValueTimestamp.PRECISION, "TIMESTAMP", ValueTimestamp.DEFAULT_SCALE, ValueTimestamp.DISPLAY_SIZE), new String[]{"TIMESTAMP", "DATETIME", "SMALLDATETIME"}, 12
        // TODO value: min / max for timestamp
        );
        add(Value.BYTES, Types.VARBINARY, "Bytes", createString(false), new String[]{"VARBINARY"}, 8);
        add(Value.BYTES, Types.BINARY, "Bytes", createString(false), new String[]{"BINARY", "RAW", "BYTEA", "LONG RAW"}, 8);
        add(Value.BYTES, Types.LONGVARBINARY, "Bytes", createString(false), new String[]{"LONGVARBINARY"}, 8);
        add(Value.UUID, Types.BINARY, "Bytes", createString(false), new String[]{"UUID"}, 8);
        add(Value.JAVA_OBJECT, Types.OTHER, "Object", createString(false), new String[]{"OTHER", "OBJECT", "JAVA_OBJECT"}, 8);
        add(Value.BLOB, Types.BLOB, "Bytes", createString(false), new String[]{"BLOB", "TINYBLOB", "MEDIUMBLOB", "LONGBLOB", "IMAGE", "OID"}, 10);
        add(Value.CLOB, Types.CLOB, "String", createString(true), new String[]{"CLOB", "TINYTEXT", "TEXT", "MEDIUMTEXT", "LONGTEXT", "NTEXT", "NCLOB"}, 10);
        DataType dataType = new DataType();
        dataType.prefix = "(";
        dataType.suffix = "')";
        add(Value.ARRAY, Types.ARRAY, "Array", dataType, new String[]{"ARRAY"}, 10);
        dataType = new DataType();
        add(Value.RESULT_SET, 0, "ResultSet", dataType, new String[]{"RESULT_SET"}, 20);
        for (int i = 0; i < TYPES_BY_VALUE_TYPE.size(); i++) {
            final DataType dt = (DataType) TYPES_BY_VALUE_TYPE.get(i);
            if (dt == null) {
    ...
    private static void add(final int type, final int sqlType, final String jdbc, final DataType dataType, final String[] names, final int memory) {
        ...
        for (int i = 0; i < names.length; i++) {
            ...
            for (int j = 0; j < TYPES.size(); j++) {
                final DataType t2 = (DataType) TYPES.get(j);
    ...
    private static DataType createDecimal(final int maxPrecision, final int defaultPrecision, final int defaultScale, final int defaultDisplaySize, final boolean needsPrecisionAndScale, final boolean autoInc) {
    ...
    private static DataType createDate(final int precision, final String prefix, final int scale, final int displaySize) {
    ...
    private static DataType createString(final boolean caseSensitive) {
     ...
     * @return the value
     */
    public static Value readValue(final SessionInterface session, final ResultSet rs, final int columnIndex, final int type) throws SQLException {
        ...
        switch (type) {
            ...
            case Value.BYTES: {
                final byte[] buff = rs.getBytes(columnIndex);
            ...
            case Value.CLOB: {
                if (session == null) {
                    ...
                    final Reader in = rs.getCharacterStream(columnIndex);
                    if (in == null) {
            ...
            case Value.BLOB: {
                if (session == null) {
                    ...
                    final InputStream in = rs.getBinaryStream(columnIndex);
            ...
            case Value.ARRAY: {
                ...
                if (array == null) { return ValueNull.INSTANCE; }
                final Object[] list = (Object[]) array.getArray();
                if (list == null) { return ValueNull.INSTANCE; }
                final Value[] values = new Value[list.length];
     ...
     */
    public static String getTypeClassName(final int type) {
     ...
     */
    public static DataType getDataType(final int type) {
     ...
     * @return the SQL type
     */
    public static int convertTypeToSQLType(final int type) {
     ...
     */
    public static int convertSQLTypeToValueType(final int sqlType) throws SQLException {
     ...
     * @return the value type
     */
    public static int getTypeFromClass(final Class x) throws SQLException {

        if (x == null) { return Value.NULL; }
        if (ResultSet.class.isAssignableFrom(x)) { return Value.RESULT_SET; }
        if (String.class.isAssignableFrom(x)) { return Value.STRING; }
        if (BigDecimal.class.isAssignableFrom(x)) { return Value.DECIMAL; }
        if (Boolean.class.isAssignableFrom(x) || boolean.class.isAssignableFrom(x)) { return Value.BOOLEAN; }
        if (Byte.class.isAssignableFrom(x) || byte.class.isAssignableFrom(x)) { return Value.BYTE; }
        if (Short.class.isAssignableFrom(x) || short.class.isAssignableFrom(x)) { return Value.SHORT; }
        if (Integer.class.isAssignableFrom(x) || int.class.isAssignableFrom(x)) { return Value.INT; }
        if (Character.class.isAssignableFrom(x) || char.class.isAssignableFrom(x)) { throw Message.getSQLException(ErrorCode.DATA_CONVERSION_ERROR_1, "char (not supported)"); }
        if (Long.class.isAssignableFrom(x) || long.class.isAssignableFrom(x)) { return Value.LONG; }
        if (Float.class.isAssignableFrom(x) || float.class.isAssignableFrom(x)) { return Value.FLOAT; }
        if (Double.class.isAssignableFrom(x) || double.class.isAssignableFrom(x)) { return Value.DOUBLE; }
        if (byte[].class.isAssignableFrom(x)) { return Value.BYTES; }
        if (Date.class.isAssignableFrom(x)) { return Value.DATE; }
        if (Time.class.isAssignableFrom(x)) { return Value.TIME; }
        if (Timestamp.class.isAssignableFrom(x)) { return Value.TIMESTAMP; }
        if (java.util.Date.class.isAssignableFrom(x)) { return Value.TIMESTAMP; }
        if (java.io.Reader.class.isAssignableFrom(x)) { return Value.CLOB; }
        if (java.sql.Clob.class.isAssignableFrom(x)) { return Value.CLOB; }
        if (java.io.InputStream.class.isAssignableFrom(x)) { return Value.BLOB; }
        if (java.sql.Blob.class.isAssignableFrom(x)) { return Value.BLOB; }
        if (Object[].class.isAssignableFrom(x)) { return Value.ARRAY; }
        if (Void.TYPE == x) { return Value.NULL; }
        return Value.JAVA_OBJECT;
    }
     ...
     * @return the value
     */
    public static Value convertToValue(final SessionInterface session, final Object x, final int type) throws SQLException {
        ...
        if (x instanceof String) {
            ...
            final Reader r = new BufferedReader((java.io.Reader) x);
            return ValueLob.createClob(r, -1, session.getDataHandler());
        }
        else if (x instanceof java.sql.Clob) {
            final Reader r = new BufferedReader(((java.sql.Clob) x).getCharacterStream());
            return ValueLob.createClob(r, -1, session.getDataHandler());
        }
     ...
     * @return the data type object
     */
    public static DataType getTypeByName(final String s) {
     ...
     */
    public static boolean isLargeObject(final int type) {

        if (type == Value.BLOB || type == Value.CLOB) { return true; }
        return false;
    }
     ...
     */
    public static boolean supportsAdd(final int type) {
     ...
     */
    public static int getAddProofType(final int type) {
     ...
     */
    public static Object getDefaultForPrimitiveType(final Class clazz) {
        ...
        else if (clazz == Double.TYPE) { return ObjectUtils.getDouble(0); }
     ...
     */
    public static Object convertTo(final SessionInterface session, final JdbcConnection conn, final Value v, final Class paramClass) throws SQLException {

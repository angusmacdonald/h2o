...
public class ValueDouble extends Value {
    ...
    public Value divide(Value v) throws SQLException {
        ...
        ValueDouble v2 = (ValueDouble) v;
        if (v2.value == 0.0) { throw Message.getSQLException(ErrorCode.DIVISION_BY_ZERO_1, getSQL()); }
        return ValueDouble.get(value / v2.value);
    }
    ...
    public static ValueDouble get(double d) {
        ...
        else if (DOUBLE_ONE == d) { return ONE; }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ValueDouble)) { return false; }

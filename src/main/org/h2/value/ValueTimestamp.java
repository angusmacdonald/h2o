...
public class ValueTimestamp extends Value {
    ...
    /**
     * The display size of the textual representation of a timestamp. Example: 2001-01-01 23:59:59.000
     */
    ...
    /**
     * This is used to find out if a date is possibly BC. Because of time zone issues (the date is time zone specific), the second day is
     * used. That means the value is not exact, but it does not need to be.
     */
    ...
    /**
     * Get or create a timestamp value for the given timestamp. Clone the timestamp.
     * 
     * @param timestamp
     *            the timestamp
     * @return the value
    ...
    /**
     * Get or create a timestamp value for the given timestamp. Do not clone the timestamp.
     * 
     * @param timestamp
     *            the timestamp
     * @return the value

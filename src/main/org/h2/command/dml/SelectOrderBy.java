...
public class SelectOrderBy {
    ...
    /**
     * The column index expression. This can be a column index number (1 meaning the first column of the select list) or a parameter (the
     * parameter is a number representing the column index number).
     */

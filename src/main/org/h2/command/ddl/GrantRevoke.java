...
public class GrantRevoke extends DefineCommand {
    ...
    public void setGranteeName(String granteeName) throws SQLException {
        ...
        if (grantee == null) {
            ...
            if (grantee == null) { throw Message.getSQLException(ErrorCode.USER_OR_ROLE_NOT_FOUND_1, granteeName); }
        }
    }
    ...
    public int update() throws SQLException {
        ...
        if (roleNames != null) {
            for (int i = 0; i < roleNames.size(); i++) {
                ...
                if (grantedRole == null) { throw Message.getSQLException(ErrorCode.ROLE_NOT_FOUND_1, name); }
    ...
    private void grantRole(Role grantedRole) throws SQLException {
        ...
        if (grantedRole != grantee && grantee.isRoleGranted(grantedRole)) { return; }

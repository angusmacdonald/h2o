...
public class CreateTable extends SchemaCommand {
     ...
     * @param tableInfo
     */
    private void addInformationToSystemTable(ISystemTable systemTable, ISystemTableReference systemTableReference, TableInfo tableInfo) throws RemoteException, MovedException, SQLException {
        ...
        try {
            ...
            H2OEventBus.publish(new H2OEvent(this.session.getDatabase().getURL().getDbLocation(), DatabaseStates.TABLE_CREATION, tableInfo.getFullTableName()));
        }

...
public class DropView extends SchemaCommand {
    ...
    public int update() throws SQLException {
        ...
        if (view == null) {
            if (!ifExists) { throw Message.getSQLException(ErrorCode.VIEW_NOT_FOUND_1, viewName); }
        }
        else {
            if (!Table.VIEW.equals(view.getTableType())) { throw Message.getSQLException(ErrorCode.VIEW_NOT_FOUND_1, viewName); }

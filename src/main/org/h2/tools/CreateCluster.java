...
public class CreateCluster extends Tool {
    ...
    /**
     * The command line interface for this tool. The options must be split into strings like this: "-urlSource", "jdbc:h2:test",... Options
     * are case sensitive. The following options are supported:
     * <ul>
    ...
    private void process(String urlSource, String urlTarget, String user, String password, String serverList) throws SQLException {
        ...
        try {
            ...
            if (exists) { throw new SQLException("Target database must not yet exist. Please delete it first"); }

...
// ## AWT begin ##
    ...
    private boolean createTrayIcon() {
        ...
        try {
            ...
            if (!supported.booleanValue()) { return false; }
            ...
            // menuConsole);
            Object trayIcon = Class.forName("java.awt.TrayIcon").getConstructor(new Class[]{Image.class, String.class, PopupMenu.class}).newInstance(new Object[]{icon, "H2 Database Engine", menuConsole});

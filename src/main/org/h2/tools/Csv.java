...
public class Csv implements SimpleRowSource {
	...
	private ResultSet readResultSet(String[] colNames) throws SQLException,
			IOException {
	...
	/**
	 * Set the field delimiter. The default is " (a double quote). The value 0
	 * means no field delimiter is used.
	 * 
	 ...
	 * default is " (a double quote). The value 0 means no escape character is
	 * used.
	 * 

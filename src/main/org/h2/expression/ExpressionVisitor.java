...
public class ExpressionVisitor {
	...
	/**
	 * Is the value independent on unset parameters or on columns of a higher level query, or sequence values (that means can it be
	 * evaluated right now)?
	 */
	...
	/**
	 * Update the field maxDataModificationId if this value is higher than the current value. This is used for SET_MAX_DATA_MODIFICATION_ID
	 * visitors.
	 * 
	 * @param value

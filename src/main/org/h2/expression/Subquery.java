...
/**
 * A query returning a single value. Subqueries are used inside other statements.
 */
public class Subquery extends Expression {
    ...
    public Value getValue(Session session) throws SQLException {
        ...
        try {
            ...
            if (rowcount > 1) { throw Message.getSQLException(ErrorCode.SCALAR_SUBQUERY_CONTAINS_MORE_THAN_ONE_ROW); }
            Value v;
            if (rowcount <= 0) {

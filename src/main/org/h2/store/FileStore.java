...
public class FileStore {
     ...
     * @return the created object
     */
    public static FileStore open(DataHandler handler, String name, String mode, String cipher, byte[] key, int keyIterations) throws SQLException {
    ...
    public void init() throws SQLException {
        ...
        if (length() < HEADER_LENGTH) {
            ...
            if (ByteUtils.compareNotNull(buff, magic) != 0) { throw Message.getSQLException(ErrorCode.FILE_VERSION_ERROR_1, name); }
            salt = new byte[len];
            ...
            if (ByteUtils.compareNotNull(buff, magic) != 0) { throw Message.getSQLException(ErrorCode.FILE_ENCRYPTION_ERROR_1, name); }
        }
    }

...
/**
 * A record represents a persisted row in a table, or a index page. When a record is persisted to disk, it is first written into a
 * {@link DataPage} buffer.
 */
public abstract class Record extends CacheObject {
    ...
    /**
     * This method is called just before the page is written. If a read operation is required before writing, this needs to be done here.
     * Because the data page buffer is shared for read and write operations. The method may read data and change the file pointer.
     */
    ...
    public boolean canRemove() {
        ...
        if ((isChanged() && !isLogWritten()) || isPinned()) { return false; }

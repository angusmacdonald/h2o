...
/**
 * A data handler contains a number of callback methods. The most important
 * implementing class is a database.
 */
public interface DataHandler {
	...
	/**
	 * Check if the simulated power failure occurred. This call will decrement
	 * the countdown.
	 * 
	 * @throws SQLException
	...
	/**
	 * Free up disk space if possible. This method is called if more space is
	 * needed.
	 * 
	 * @throws SQLException
	 *             if no more space could be freed
	 */
	...
	/**
	 * Get the next object id. This method is not required if
	 * LOB_FILES_IN_DIRECTORIES is enabled.
	 * 
	 * @param needFresh

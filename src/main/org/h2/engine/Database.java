...
public class Database implements DataHandler {
    ...
    public Database(String name, ConnectionInfo ci, String cipher) throws SQLException {
        ...
        if (Constants.IS_H2O && !isManagementDB()) setDiagnosticLevel(localMachineLocation);
    ...
    private synchronized void open(int traceLevelFile, int traceLevelSystemOut, ConnectionInfo ci, DatabaseURL localMachineLocation) throws SQLException, StartupException {
        ...
        if (Constants.IS_H2O && !isManagementDB()) Diagnostic.traceNoEvent(DiagnosticLevel.INIT, " Executed meta-records.");
    ...
    private void setDiagnosticLevel(DatabaseURL localMachineLocation) {
        ...
        if (diagnosticLevel != null) {
            ...
            else if (diagnosticLevel.equals("INIT")) Diagnostic.setLevel(DiagnosticLevel.INIT);

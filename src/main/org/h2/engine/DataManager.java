...
public class DataManager implements DataManagerRemote {
	...
	private void addInformationToDB(long modificationID,
			...
			String localMachineAddress, int localMachinePort, String connection_type, int tableSet) throws SQLException {
	...
	public String getPrimaryReplicaLocation() throws SQLException{
	 ...
	 * @return
	 */
	public int getTableID() throws SQLException{

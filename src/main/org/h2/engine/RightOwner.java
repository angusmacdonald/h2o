...
public abstract class RightOwner extends DbObjectBase {
    ...
    public boolean isRoleGranted(Role grantedRole) {
        ...
        if (grantedRole == this) { return true; }
        if (grantedRoles != null) {
            Iterator it = grantedRoles.keySet().iterator();
            while (it.hasNext()) {
                Role role = (Role) it.next();
                if (role == grantedRole) { return true; }
                if (role.isRoleGranted(grantedRole)) { return true; }
            }
        }
        return false;
    }
    ...
    boolean isRightGrantedRecursive(Table table, int rightMask) {
        ...
        if (grantedRights != null) {
            ...
            if (right != null) {
                if ((right.getRightMask() & rightMask) == rightMask) { return true; }
            }
        }
        if (grantedRoles != null) {
            Iterator it = grantedRoles.keySet().iterator();
            while (it.hasNext()) {
                ...
                if (role.isRightGrantedRecursive(table, rightMask)) { return true; }
            }
        }
        return false;
    }
    ...
    public Right getRightForTable(Table table) {
        ...
        if (grantedRights == null) { return null; }
    ...
    public Right getRightForRole(Role role) {
        ...
        if (grantedRoles == null) { return null; }

...
public class SysProperties {
	 ...
	 */
	public static final String FILE_ENCODING = getStringSetting(
	 ...
	 */
	public static final String FILE_SEPARATOR = getStringSetting(
			"file.separator", "/");
	 ...
	 */
	public static final String JAVA_SPECIFICATION_VERSION = getStringSetting(
	 ...
	 */
	public static final String LINE_SEPARATOR = getStringSetting(
			"line.separator", "\n");
	 ...
	 * </p>
	 */
	public static final boolean ALIAS_COLUMN_NAME = getBooleanSetting(
			"h2.aliasColumnName", Constants.VERSION <= 1.0);
	 ...
	 */
	public static final boolean ALLOW_BIG_DECIMAL_EXTENSIONS = getBooleanSetting(
	 ...
	 */
	public static final String ALLOWED_CLASSES = getStringSetting(
			"h2.allowedClasses", "*");
	 ...
	 */
	public static final boolean ENABLE_ANONYMOUS_SSL = getBooleanSetting(
			"h2.enableAnonymousSSL", true);

	/**
	 * System property <code>h2.bindAddress</code> (default: *).<br />
	 * Comma separated list of class names or prefixes.
	 */
	public static final String BIND_ADDRESS = getStringSetting(
			"h2.bindAddress", null);
	 ...
	 */
	public static final int CACHE_SIZE_DEFAULT = getIntSetting(
			"h2.cacheSizeDefault", 16 * 1024);
	 ...
	 * cacheSizeIndexShift.
	 */
	public static final int CACHE_SIZE_INDEX_SHIFT = getIntSetting(
			"h2.cacheSizeIndexShift", 3);
	 ...
	 * client / server).
	 */
	public static final String CLIENT_TRACE_DIRECTORY = getStringSetting(
	 ...
	 */
	public static final int DEFAULT_MAX_OPERATION_MEMORY = getIntSetting(
			"h2.defaultMaxOperationMemory", 100000);
	 ...
	 * error.
	 */
	public static final int DATASOURCE_TRACE_LEVEL = getIntSetting(
			"h2.dataSourceTraceLevel", TraceSystem.ERROR);

	/**
	 * System property <code>h2.defaultMaxMemoryUndo</code> (default: 50000).<br />
	 * The default value for the MAX_MEMORY_UNDO setting.
	 */
	public static final int DEFAULT_MAX_MEMORY_UNDO = getIntSetting(
	 ...
	 */
	public static final int DEFAULT_LOCK_MODE = getIntSetting(
			"h2.defaultLockMode", Constants.LOCK_MODE_READ_COMMITTED);
	 ...
	 */
	public static final int DELAY_WRONG_PASSWORD_MIN = getIntSetting(
			"h2.delayWrongPasswordMin", 250);
	 ...
	 * maximum delay.
	 */
	public static final int DELAY_WRONG_PASSWORD_MAX = getIntSetting(
			"h2.delayWrongPasswordMax", 4000);
	 ...
	 * text, $$ is not allowed.
	 */
	public static final boolean DOLLAR_QUOTING = getBooleanSetting(
			"h2.dollarQuoting", true);
	 ...
	 */
	public static final int ESTIMATED_FUNCTION_TABLE_ROWS = getIntSetting(
			"h2.estimatedFunctionTableRows", 1000);
	 ...
	 * buffer.
	 */
	public static final int LARGE_RESULT_BUFFER_SIZE = getIntSetting(
			"h2.largeResultBufferSize", 4 * 1024);

	/**
	 * System property <code>h2.lobCloseBetweenReads</code> (default: false).<br />
	 * Close LOB files between read operations.
	 */
	public static boolean lobCloseBetweenReads = getBooleanSetting(
	...
	public static final boolean LOB_FILES_IN_DIRECTORIES = getBooleanSetting(
			"h2.lobFilesInDirectories", Constants.VERSION > 1.0);

	/**
	 * System property <code>h2.lobFilesPerDirectory</code> (default: 256).<br />
	 * Maximum number of LOB files per directory.
	 */
	public static final int LOB_FILES_PER_DIRECTORY = getIntSetting(
	 ...
	 */
	public static final boolean LOG_ALL_ERRORS = getBooleanSetting(
	 ...
	 */
	public static final String LOG_ALL_ERRORS_FILE = getStringSetting(
	 ...
	 */
	public static final int MAX_FILE_RETRY = Math.max(1,
			getIntSetting("h2.maxFileRetry", 16));
	 ...
	 * used.
	 */
	public static final int MAX_MEMORY_ROWS_DISTINCT = getIntSetting(
			"h2.maxMemoryRowsDistinct", Integer.MAX_VALUE);
	 ...
	 */
	public static final int MAX_QUERY_TIMEOUT = getIntSetting(
			H2_MAX_QUERY_TIMEOUT, 0);
	 ...
	 * system.
	 */
	public static final long MAX_TRACE_DATA_LENGTH = getIntSetting(
			"h2.maxTraceDataLength", 65535);

	/**
	 * System property <code>h2.minColumnNameMap</code> (default: 3).<br />
	 * The minimum number of columns where a hash table is created when result
	 * set methods with column name (instead of column index) parameter are
	 * called.
	 */
	public static final int MIN_COLUMN_NAME_MAP = getIntSetting(
			"h2.minColumnNameMap", 3);

	/**
	 * System property <code>h2.minWriteDelay</code> (default: 5).<br />
	 * The minimum write delay that causes commits to be delayed.
	 */
	public static final int MIN_WRITE_DELAY = getIntSetting("h2.minWriteDelay",
			5);

	/**
	 * System property <code>h2.nioLoadMapped</code> (default: false).<br />
	 * If the mapped buffer should be loaded when the file is opened. This can
	 * improve performance.
	 */
	public static final boolean NIO_LOAD_MAPPED = getBooleanSetting(
			"h2.nioLoadMapped", false);
	 ...
	 */
	public static final boolean NIO_CLEANER_HACK = getBooleanSetting(
			"h2.nioCleanerHack", true);

	/**
	 * System property <code>h2.objectCache</code> (default: true).<br />
	 * Cache commonly used objects (integers, strings).
	 */
	public static final boolean OBJECT_CACHE = getBooleanSetting(
			"h2.objectCache", true);
	 ...
	 */
	public static final int OBJECT_CACHE_MAX_PER_ELEMENT_SIZE = getIntSetting(
	...
	public static final int OBJECT_CACHE_SIZE = MathUtils
			.nextPowerOf2(getIntSetting("h2.objectCacheSize", 1024));
	 ...
	 * </p>
	 */
	public static final boolean OLD_COMMAND_LINE_OPTIONS = getBooleanSetting(
			"h2.oldCommandLineOptions", Constants.VERSION < 1.1);
	 ...
	 */
	public static final boolean OPTIMIZE_DROP_DEPENDENCIES = getBooleanSetting(
			"h2.optimizeDropDependencies", true);
	 ...
	 * </ul>
	 */
	public static final boolean OPTIMIZE_DISTINCT = getBooleanSetting(
			"h2.optimizeDistinct", true);
	 ...
	 */
	public static final boolean OPTIMIZE_EVALUATABLE_SUBQUERIES = getBooleanSetting(
			"h2.optimizeEvaluatableSubqueries", true);
	 ...
	 * </p>
	 */
	public static final boolean OPTIMIZE_GROUP_SORTED = getBooleanSetting(
			"h2.optimizeGroupSorted", Constants.VERSION > 1.0);

	/**
	 * System property <code>h2.optimizeIn</code> (default: true).<br />
	 * Optimize IN(...) comparisons.
	 */
	public static final boolean OPTIMIZE_IN = getBooleanSetting(
			"h2.optimizeIn", true);
	 ...
	 * </p>
	 */
	public static boolean optimizeInJoin = getBooleanSetting(
			"h2.optimizeInJoin", Constants.VERSION > 1.0);

	/**
	 * System property <code>h2.optimizeMinMax</code> (default: true).<br />
	 * Optimize MIN and MAX aggregate functions.
	 */
	public static final boolean OPTIMIZE_MIN_MAX = getBooleanSetting(
	 ...
	 */
	public static final boolean OPTIMIZE_SUBQUERY_CACHE = getBooleanSetting(
	 ...
	 */
	public static final boolean OPTIMIZE_NOT = getBooleanSetting(
			"h2.optimizeNot", true);
	 ...
	 */
	public static final boolean OPTIMIZE_TWO_EQUALS = getBooleanSetting(
			"h2.optimizeTwoEquals", true);

	/**
	 * System property <code>h2.overflowExceptions</code> (default: true).<br />
	 * Throw an exception on integer overflows.
	 */
	public static final boolean OVERFLOW_EXCEPTIONS = getBooleanSetting(
	 ...
	 */
	public static final boolean PAGE_STORE = getBooleanSetting("h2.pageStore",
			false);
	 ...
	 */
	public static final boolean RECOMPILE_ALWAYS = getBooleanSetting(
	 ...
	 */
	public static final int RECONNECT_CHECK_DELAY = getIntSetting(
			"h2.reconnectCheckDelay", 250);

	/**
	 * System property <code>h2.redoBufferSize</code> (default: 262144).<br />
	 * Size of the redo buffer (used at startup when recovering).
	 */
	public static final int REDO_BUFFER_SIZE = getIntSetting(
			"h2.redoBufferSize", 256 * 1024);
	 ...
	 */
	public static final int RESERVE_MEMORY = getIntSetting("h2.reserveMemory",
			512 * 1024);
	 ...
	 * </p>
	 */
	public static final boolean RETURN_LOB_OBJECTS = getBooleanSetting(
			"h2.returnLobObjects", Constants.VERSION > 1.0);

	/**
	 * System property <code>h2.reuseSpaceAfter</code> (default: 16).<br />
	 * Reuse space in database files after this many pages are free.
	 */
	public static final int REUSE_SPACE_AFTER = getIntSetting(
			"h2.reuseSpaceAfter", 32);

	/**
	 * System property <code>h2.reuseSpaceQuickly</code> (default: true).<br />
	 * Reuse space in database files quickly.
	 */
	public static final boolean REUSE_SPACE_QUICKLY = getBooleanSetting(
			"h2.reuseSpaceQuickly", true);

	/**
	 * System property <code>h2.runFinalize</code> (default: true).<br />
	 * Run finalizers to detect unclosed connections.
	 */
	public static boolean runFinalize = getBooleanSetting("h2.runFinalize",
			true);
	 ...
	 */
	public static final int SERVER_CACHED_OBJECTS = getIntSetting(
	 ...
	 */
	public static final int SERVER_RESULT_SET_FETCH_SIZE = getIntSetting(
	 ...
	 * </p>
	 */
	public static final boolean SHARE_LINKED_CONNECTIONS = getBooleanSetting(
			"h2.shareLinkedConnections", Constants.VERSION > 1.0);

	/**
	 * System property <code>h2.socketConnectTimeout</code> (default: 2000).<br />
	 * The timeout in milliseconds to connect to a server.
	 */
	public static final int SOCKET_CONNECT_TIMEOUT = getIntSetting(
	 ...
	 */
	public static final boolean SORT_NULLS_HIGH = getBooleanSetting(
	 ...
	 */
	public static final long SPLIT_FILE_SIZE_SHIFT = getIntSetting(
			"h2.splitFileSizeShift", 20);

	/**
	 * System property <code>h2.traceIO</code> (default: false).<br />
	 * Trace all I/O operations.
	 */
	public static final boolean TRACE_IO = getBooleanSetting("h2.traceIO",
			false);
	 ...
	 */
	public static final int WEB_MAX_VALUE_LENGTH = getIntSetting(
			"h2.webMaxValueLength", 10000);
	...
	/**
	 * INTERNAL. System property <code>h2.scriptDirectory</code> (default: empty
	 * string).<br />

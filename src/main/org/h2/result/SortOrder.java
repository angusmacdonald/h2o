...
public class SortOrder {
     ...
     * @return the result of the comparison (-1 meaning the first expression should appear before the second, 0 if they are equal)
     */
    ...
    public int compare(Value[] a, Value[] b) throws SQLException {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (comp != 0) { return (type & DESCENDING) == 0 ? comp : -comp; }
        }
        return 0;
    }

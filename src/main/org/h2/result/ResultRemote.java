...
/**
 * The client side part of a result set that is kept on the server. In many cases, the complete data is kept on the client side, but for
 * large results only a subset is in-memory.
 */

...
/**
 * The result interface is used by the LocalResult and ResultRemote class. A
 * result may contain rows, or just an update count.
 */
public interface ResultInterface {
	...
	/**
	 * Get the current row id, starting with 0. -1 is returned when next() was
	 * not called yet.
	 * 
	 * @return the row id
	 */
	...
	/**
	 * Get the number of visible columns. More columns may exist internally for
	 * sorting or grouping.
	 * 

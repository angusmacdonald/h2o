...
/**
 * A local result set contains all row data of a result set. This is the object generated by engine, and it is also used directly by the
 * ResultSet class in the embedded mode. If the result does not fit in memory, it is written to a temporary file.
 */
public class LocalResult implements ResultInterface {
    ...
    public LocalResult createShallowCopy(Session session) {
        ...
        if (disk == null && (rows == null || rows.size() < rowCount)) { return null; }

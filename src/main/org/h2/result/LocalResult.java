...
public class LocalResult implements ResultInterface {
	 ...
	 *            the number of visible columns
	 */
	public LocalResult(Session session, ObjectArray expressionList,
			int visibleColumnCount) {
	...
	private static ObjectArray getExpressionColumns(Session session,
		...
		for (int i = 0; i < columnCount; i++) {
			...
			int type = DataType.convertSQLTypeToValueType(meta
					.getColumnType(i + 1));
			...
			if (distinctRows != null) {
				...
				if (disk != null && sort != null) {
					...
					while (true) {
						...
						if (disk == null) {
							disk = new ResultDiskBuffer(session, sort,
									list.length);
						}
						rows.add(list);
	...
	public String toString() {
		return "columns: " + visibleColumnCount + " rows: " + rowCount
				+ " pos: " + rowId;
	}

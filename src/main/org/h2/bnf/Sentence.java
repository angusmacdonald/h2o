...
public class Sentence {
	...
	/**
	 * This token type means the possible choices of the item depend on the context. For example the item represents a table name of the
	 * current database.
	 */
	...
	/**
	 * Check if it's time to stop processing. Processing auto-complete shouldn't take more than a few milliseconds.
	 * 

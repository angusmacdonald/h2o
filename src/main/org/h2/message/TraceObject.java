...
public class TraceObject {
	...
	private static final String[] PREFIX = { "call", "conn", "dbMeta", "prep", "rs", "rsMeta", "sp", "ex", "stat", "blob", "clob", "pMeta",
			"ds", "xads", "xid", "ar" };
	 ...
	 *            the prefix type
	 * @param id
	 *            the trace object id of the created object
	 * @param value

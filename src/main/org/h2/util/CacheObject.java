...
public abstract class CacheObject {
    ...
    /**
     * Ensure the class is loaded when initialized, so that sorting is possible even when loading new classes is not allowed any more. This
     * can occur when stopping a web application.
     */
    static {
        new CacheComparator();
    }

...
/**
 * The string cache helps re-use string objects and therefore save memory. It uses a soft reference cache to keep frequently used strings in
 * memory. The effect is similar to calling String.intern(), but faster.
 */
public class StringCache {
    ...
    /**
     * Get the string from the cache if possible. If the string has not been found, it is added to the cache. If there is such a string in
     * the cache, that one is returned.
     * 
     * @param s
     *            the original string
    ...
    /**
     * Get a string from the cache, and if no such string has been found, create a new one with only this content. This solves out of memory
     * problems if the string is a substring of another, large string. In Java, strings are shared, which could lead to memory problems.
     * This avoid such problems.
     * 
     * @param s
     *            the string

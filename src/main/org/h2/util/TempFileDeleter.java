...
public class TempFileDeleter {
    ...
    /**
     * Update the last modified date of the auto-delete reference. If the file was modified after that, it will not be deleted (because it
     * might have been deleted and then re-created).
     * 
     * @param ref
     *            the reference
     */

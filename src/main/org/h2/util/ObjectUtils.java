...
public class ObjectUtils {
    ...
    public static Integer getInteger(int x) {
        ...
        // ## Java 1.5 begin ##
        if (true) { return Integer.valueOf(x); }
        // ## Java 1.5 end ##
        // NOPMD
    ...
    public static Character getCharacter(char x) {
        ...
        // ## Java 1.5 begin ##
        if (true) { return Character.valueOf(x); }
        // ## Java 1.5 end ##
    ...
    public static Short getShort(short x) {
        ...
        // ## Java 1.5 begin ##
        if (true) { return Short.valueOf(x); }
        // ## Java 1.5 end ##
        // NOPMD
        return new Short(x);
    }
    ...
    public static Float getFloat(float x) {
        ...
        // ## Java 1.5 begin ##
        if (true) { return Float.valueOf(x); }
        // ## Java 1.5 end ##
        return new Float(x);
    }
    ...
    public static Double getDouble(double x) {
        ...
        // ## Java 1.5 begin ##
        if (true) { return Double.valueOf(x); }
        // ## Java 1.5 end ##
        return new Double(x);
    }

...
public class Column {
    ...
    public boolean equals(Object o) {
        ...
        else if (!(o instanceof Column)) { return false; }
        Column other = (Column) o;
        if (table == null || other.table == null || name == null || other.name == null) { return false; }
    ...
    /**
     * Validate the value, convert it if required, and update the sequence value if required. If the value is null, the default value (NULL
     * if no default is set) is returned. Check constraints are validated as well.
     * 
     * @param session
     *            the session
     * @param value
    ...
    public Value validateConvertUpdateSequence(Session session, Value value) throws SQLException {
        ...
        if (checkConstraint != null) {
            ...
            if (Boolean.FALSE.equals(v.getBoolean())) { throw Message.getSQLException(ErrorCode.CHECK_CONSTRAINT_VIOLATED_1, checkConstraint.getSQL()); }
        }
    ...
    /**
     * Get the selectivity of the column. Selectivity 100 means values are unique, 10 means every distinct value appears 10 times on
     * average.
     * 
    ...
    public Expression getCheckConstraint(Session session, String asColumnName) throws SQLException {
        ...
        if (checkConstraint == null) { return null; }
     ...
     * @param visitor
     *            the visitor
     * @return true if every visited expression returned true, or if there are no expressions
     */
    boolean isEverything(ExpressionVisitor visitor) {
        ...
        if (defaultExpression != null && !defaultExpression.isEverything(visitor)) { return false; }
        if (checkConstraint != null && !checkConstraint.isEverything(visitor)) { return false; }
        return true;
    }

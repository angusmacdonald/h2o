...
public class TableLink extends Table {
	...
	public TableLink(Schema schema, int id, String name, String driver, String url, String user, String password, String originalSchema,
	...
	private void readMetaData() throws SQLException {
		...
		try {
			...
			throw Message
					.getSQLException(ErrorCode.TABLE_OR_VIEW_NOT_FOUND_1, new String[] { originalTable + "(" + e.toString() + ")" }, e);
		} finally {

...
/**
 * A user-defined aggregate function needs to implement this interface. The class must be public and must have a public non-argument
 * constructor.
 */
public interface AggregateFunction {
    ...
    /**
     * This method must return the SQL type of the method, given the SQL type of the input data. The method should check here if the number
     * of parameters passed is correct, and if not it should throw an exception.
     * 
     * @param inputTypes

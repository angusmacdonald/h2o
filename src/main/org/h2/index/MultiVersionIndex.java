...
/**
 * A multi-version index is a combination of a regular index, and a in-memory tree index that contains uncommitted changes. Uncommitted
 * changes can include new rows, and deleted rows.
 */

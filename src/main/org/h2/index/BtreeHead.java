...
/**
 * The head page of a b-tree index. There is exactly one head page for each such index, and it contains meta data such as the location of
 * the root page. Unlike the root page of a b-tree index, the head page always stays at the same place.
 */
